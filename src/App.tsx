      ...
      <div className={`flex items-center justify-between px-2 sm:px-3 md:px-4 py-2 sm:py-3 border-b relative overflow-hidden flex-shrink-0 ${
        ...
        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-theme-primary via-theme-accent to-theme-primary opacity-80"></div>
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4 flex-shrink-0">
            {/* Hamburger: mobile = toggle drawer, desktop = click to pin/unpin, hover to peek */}
            <button
              ...
              title={isMobile ? 'Toggle Sidebar' : (state.isSidebarOpen ? 'Collapse Sidebar (Ctrl+B)' : 'Expand Sidebar (Ctrl+B)')}
            >
              <svg className={isMobile ? 'w-5 h-5 sm:w-6 sm:h-6' : 'w-5 h-5'} fill="none" stroke="currentColor" viewBox="0 0 24 24">
